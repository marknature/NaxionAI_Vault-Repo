# reflections-2026-08-26 — Dataset Knowledge Pack
...
## Provenance & audit
- **Dataset id**: `reflections-2026-08-26-mtbgf8fh`
- **Source**: Intellinexus daily reflection
- **Sector**: operations
- **Published**: 2026-08-27T11:43:30.415Z
- **Batch root hash** (tamper-evident): `3f2db9c2d46e27599ed8758f9e7c155b4fb6b5e385365cff4d7868a64994fd36`
...
| Cryptographic Hashing | 1 | 1 | SHA-256 per record; batch root 3f2db9c2d46e… |
...
- **ML CSV** — `_datasets/reflections-2026-08-26-mtbgf8fh/dataset.csv`
- **Knowledge-graph JSONL** — `_datasets/reflections-2026-08-26-mtbgf8fh/graph.jsonl`
- **RAG chunks** — `_datasets/reflections-2026-08-26-mtbgf8fh/rag.md`
