...
created: 2026-09-17T20:04:51.146Z
...
# Flag risks the engineering plan didn't see (race conditions, data states, bro… (custom-qa-engineer-flag-risks-the-engineering-plan-didn-t-s)

Persona-derived starter task for "Quinn".

**Origin task:** As a QA Engineer, flag risks the engineering plan didn't see (race conditions, data states, browser quirks).
