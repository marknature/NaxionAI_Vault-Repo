...
# Distinguish shipped from announced-but-not-shipped (custom-product-intel-distinguish-shipped-from-announced-but-n)

Persona-derived starter task for "Rion".

**Origin task:** As a Product Intelligence Analyst, distinguish shipped from announced-but-not-shipped.
