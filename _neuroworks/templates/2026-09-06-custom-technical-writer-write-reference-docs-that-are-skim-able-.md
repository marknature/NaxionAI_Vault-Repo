...
created: 2026-09-06T12:04:40.257Z
...
# Write reference docs that are skim-able and grep-able (custom-technical-writer-write-reference-docs-that-are-skim-able-)

Persona-derived starter task for "Tao".

**Origin task:** As a Technical Writer, write reference docs that are skim-able and grep-able.
