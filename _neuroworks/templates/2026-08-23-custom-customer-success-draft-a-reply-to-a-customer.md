...
created: 2026-08-23T09:56:48.596Z
...
# Draft a reply to a customer (custom-customer-success-draft-a-reply-to-a-customer)

Read the customer's message, identify the real need, draft a reply that resolves it.

**Origin task:** Draft a customer reply. Steps: 1) Read the message and name the tone (frustrated / confused / excited / neutral). 2) Identify the underlying need (often different from the literal ask). 3) Draft a reply that opens with the right acknowledgment, resolves the real need, attaches a date to any commitment. 4) Flag any churn-risk or expansion-signal language separately. No macro-speak.
