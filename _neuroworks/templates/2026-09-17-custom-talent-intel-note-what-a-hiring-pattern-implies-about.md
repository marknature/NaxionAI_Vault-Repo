...
# Note what a hiring pattern implies about direction, when evident (custom-talent-intel-note-what-a-hiring-pattern-implies-about)

Persona-derived starter task for "Nadia".

**Origin task:** As a Talent Intelligence Analyst, note what a hiring pattern implies about direction, when evident.
