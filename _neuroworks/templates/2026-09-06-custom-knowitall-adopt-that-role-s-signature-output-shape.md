...
created: 2026-09-06T12:04:40.563Z
...
# Adopt that role's signature output shape and voice for the response (custom-knowitall-adopt-that-role-s-signature-output-shape)

Persona-derived starter task for "Kit".

**Origin task:** As a Polymath, any-persona adapter, adopt that role's signature output shape and voice for the response.
