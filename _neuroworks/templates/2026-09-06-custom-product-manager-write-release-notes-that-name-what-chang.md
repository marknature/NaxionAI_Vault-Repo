...
created: 2026-09-06T12:04:40.423Z
...
# Write release notes that name what changed FOR the customer, not what was shi… (custom-product-manager-write-release-notes-that-name-what-chang)

Persona-derived starter task for "Priya".

**Origin task:** As a Product Manager, write release notes that name what changed for the customer, not what was shipped.
