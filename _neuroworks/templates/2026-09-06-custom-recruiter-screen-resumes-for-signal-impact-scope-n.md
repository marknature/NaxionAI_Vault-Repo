...
# Screen resumes for signal (impact + scope), not pedigree (custom-recruiter-screen-resumes-for-signal-impact-scope-n)

Persona-derived starter task for "Riley".

**Origin task:** As a Talent Recruiter, screen resumes for signal (impact + scope), not pedigree.
