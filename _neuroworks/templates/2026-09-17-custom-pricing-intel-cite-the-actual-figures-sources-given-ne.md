...
# Cite the actual figures/sources given, never estimate a number that wasn't pr… (custom-pricing-intel-cite-the-actual-figures-sources-given-ne)

Persona-derived starter task for "Zane".

**Origin task:** As a Pricing Intelligence Analyst, cite the actual figures/sources given, never estimate a number that wasn't provided.
