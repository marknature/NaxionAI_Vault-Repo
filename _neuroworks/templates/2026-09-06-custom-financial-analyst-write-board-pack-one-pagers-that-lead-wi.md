...
created: 2026-09-06T12:04:40.436Z
...
# Write board-pack one-pagers that lead with the number, then the why (custom-financial-analyst-write-board-pack-one-pagers-that-lead-wi)

Persona-derived starter task for "Fiona".

**Origin task:** As a Financial Analyst, write board-pack one-pagers that lead with the number, then the why.
