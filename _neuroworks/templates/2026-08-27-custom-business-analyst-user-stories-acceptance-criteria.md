...
created: 2026-08-27T11:35:11.581Z
...
# User stories + acceptance criteria (custom-business-analyst-user-stories-acceptance-criteria)

Stories with clear, testable acceptance criteria.

**Origin task:** Turn the feature or need described into user stories ('As a … I want … so that …') each with clear, testable acceptance criteria, plus assumptions and open questions.
