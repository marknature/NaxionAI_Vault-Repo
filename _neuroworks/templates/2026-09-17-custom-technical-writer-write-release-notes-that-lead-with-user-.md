...
created: 2026-09-17T20:04:51.332Z
...
# Write release notes that lead with user-facing benefit (custom-technical-writer-write-release-notes-that-lead-with-user-)

Persona-derived starter task for "Tao".

**Origin task:** As a Technical Writer, write release notes that lead with user-facing benefit.
