...
# Cite figures/sources exactly as given, never estimate (custom-deal-intel-cite-figures-sources-exactly-as-given-ne)

Persona-derived starter task for "Gideon".

**Origin task:** As a Deal Intelligence Analyst, cite figures/sources exactly as given, never estimate.
