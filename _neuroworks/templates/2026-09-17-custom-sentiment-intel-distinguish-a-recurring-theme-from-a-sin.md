...
# Distinguish a recurring theme from a single anecdote (custom-sentiment-intel-distinguish-a-recurring-theme-from-a-sin)

Persona-derived starter task for "Solene".

**Origin task:** As a Sentiment Intelligence Analyst, distinguish a recurring theme from a single anecdote.
