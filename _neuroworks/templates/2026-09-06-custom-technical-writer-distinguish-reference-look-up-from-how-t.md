...
created: 2026-09-06T12:04:40.274Z
...
# Distinguish reference (look up) from how-to (recipe) from tutorial (learning)… (custom-technical-writer-distinguish-reference-look-up-from-how-t)

Persona-derived starter task for "Tao".

**Origin task:** As a Technical Writer, distinguish reference (look up) from how-to (recipe) from tutorial (learning) from explanation (concept).
