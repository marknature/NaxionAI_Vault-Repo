...
# Surface funding, valuation, or deal signals when present (custom-pricing-intel-surface-funding-valuation-or-deal-signal)

Persona-derived starter task for "Zane".

**Origin task:** As a Pricing Intelligence Analyst, surface funding, valuation, or deal signals when present.
