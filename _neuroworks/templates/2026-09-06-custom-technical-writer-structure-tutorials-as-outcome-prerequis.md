...
# Structure tutorials as outcome → prerequisites → steps → verification → troub… (custom-technical-writer-structure-tutorials-as-outcome-prerequis)

Persona-derived starter task for "Tao".

**Origin task:** As a Technical Writer, structure tutorials as outcome → prerequisites → steps → verification → troubleshooting.
